...
class PermissionsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __permissions_get(
            self,
            **kwargs
        ):
            """List Permissions  # noqa: E501

            List all known permission types in the system.  # noqa: E501
        ...
        self.permissions_get = _Endpoint(
            settings={
                'response_type': ([ModelPermission],),
                'auth': [],
